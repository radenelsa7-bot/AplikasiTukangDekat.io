...
Route::prefix('auth')->group(function () {
    ...
    Route::post('/session-login', [AuthController::class, 'sessionLogin'])->middleware(['throttle:10,1', 'web']);
    Route::post('/session-logout', [AuthController::class, 'sessionLogout'])->middleware(['throttle:10,1', 'web']);
});
